...
-- None of below functions as expected except updating desc
--map("n", ";", ";", { desc = "Next Serach (fFtT)", remap = true })
--map("n", ",", ",", { desc = "Previous Serach (fFtT)", remap = true })
--map("n", ";", ";", { desc = "Next Serach (fFtT)" })
--map("n", ",", ",", { desc = "Previous Serach (fFtT)" })
...
-- Promote frequently used commands to shorter key maps
-- Read message in Telescope with '<leader>m' (Copied from '<leader>snh' with shorter desc)
map("n", "<leader>m", function() require("noice").cmd("history") end, { desc = "Messages" })
-- Dismiss All Notification in normal mode with '<leader>n' (Copied from '<leader>un')
